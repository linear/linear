import { AvoidOptionalsConfig, ParsedTypesConfig, RawTypesConfig } from "@graphql-codegen/visitor-plugin-common";

export interface RawDocPluginConfig extends RawTypesConfig {
  /**
   * @name avoidOptionals
   * @type boolean
...
export interface DocPluginConfig extends ParsedTypesConfig {
