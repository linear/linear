...
export class GitLabImporter implements Importer {
  ...
  public import = async (): Promise<ImportResult> => {
    //const url = `https://gitlab.com/api/v4/projects/${this.projectId}/issues?per_page=100`;
    ...
    const issues: GITLAB_ISSUE[] = getGitlabIssuesFromRepo(this.accessToken, projectId);
