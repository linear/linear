 ...
 */
      export function createLinearSdkUserOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 * Initialise a set of operations, scoped to adminUserAccountLookup_users_organization, to run against the Linear api
 */
      export type LinearSdkAdminUserAccountLookupUsersOrganization = ReturnType<typeof createLinearSdkAdminUserAccountLookupUsersOrganization>;
 ...
 * Initialise a set of operations, scoped to adminUserAccountLookup_users_organization_subscription, to run against the Linear api
 */
      export type LinearSdkAdminUserAccountLookupUsersOrganizationSubscription = ReturnType<typeof createLinearSdkAdminUserAccountLookupUsersOrganizationSubscription>;
 ...
 */
      export function createLinearSdkAdminUserAccountLookupUsersOrganizationSubscriptionOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 * Initialise a set of operations, scoped to adminUserAccountLookup_users_organization_subscription_organization, to run against the Linear api
 */
      export type LinearSdkAdminUserAccountLookupUsersOrganizationSubscriptionOrganization = ReturnType<typeof createLinearSdkAdminUserAccountLookupUsersOrganizationSubscriptionOrganization>;
 ...
 * Initialise a set of operations, scoped to availableUsers_availableOrganizations, to run against the Linear api
 */
      export type LinearSdkAvailableUsersAvailableOrganizations = ReturnType<typeof createLinearSdkAvailableUsersAvailableOrganizations>;
 ...
 */
      export function createLinearSdkCustomViewOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkEmojiOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkIntegrationSettings<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkIntegrationOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkIntegrationResourceData<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkMilestoneOrganization<O>(requester: LinearRequester<O>) {
        return {
 ...
 */
      export function createLinearSdkTeamOrganization<O>(requester: LinearRequester<O>) {
        return {
