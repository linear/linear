 ...
 * @property {number} [subIssueSortOrder] - The order of the item in the sub-issue list. Only set if the issue has a parent.
 ...
 * @property {string} [pendingChangeType] - The subscription type of a pending change. Null if no change pending.
 */
 ...
 * @property {SubscriptionPayload} subscriptionUpgrade - Upgrades a subscription plan.
 ...
 * @property {number} [boardOrder] - The position of the issue in its column on the board view.
 * @property {number} [subIssueSortOrder] - The position of the issue in parent's sub-issue list.
 * @property {TimelessDateScalar} [dueDate] - The date at which the issue is due.
 */
