...
feat(schema): [non_breaking] Type 'FeedSubscription' was added (FeedSubscription)

feat(schema): [non_breaking] Type 'FeedSubscriptionConnection' was added (FeedSubscriptionConnection)

feat(schema): [non_breaking] Type 'FeedSubscriptionCreateInput' was added (FeedSubscriptionCreateInput)

feat(schema): [non_breaking] Type 'FeedSubscriptionEdge' was added (FeedSubscriptionEdge)

feat(schema): [non_breaking] Type 'FeedSubscriptionPayload' was added (FeedSubscriptionPayload)

feat(schema): [non_breaking] Type 'FeedSubscriptionUpdateInput' was added (FeedSubscriptionUpdateInput)
...
feat(schema): [non_breaking] Field 'feedSubscriptionCreate' was added to object type 'Mutation' (Mutation.feedSubscriptionCreate)

feat(schema): [non_breaking] Field 'feedSubscriptionDelete' was added to object type 'Mutation' (Mutation.feedSubscriptionDelete)

feat(schema): [non_breaking] Field 'feedSubscriptionUpdate' was added to object type 'Mutation' (Mutation.feedSubscriptionUpdate)
...
feat(schema): [non_breaking] Field 'publicTeamsOnly' was added to object type 'OauthClientApproval' (OauthClientApproval.publicTeamsOnly)
...
feat(schema): [non_breaking] Field 'feedSubscription' was added to object type 'Query' (Query.feedSubscription)

feat(schema): [non_breaking] Field 'feedSubscriptions' was added to object type 'Query' (Query.feedSubscriptions)
